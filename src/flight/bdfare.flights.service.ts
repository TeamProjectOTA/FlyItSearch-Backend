...
export class BDFareService {
    ...
    private transformToRequestDto(flightSearchModel: FlightSearchModel): RequestDto {
    ...
    async processApi2(flightSearchModel: FlightSearchModel): Promise<any> {
      ...
      try {
        ...
        throw new HttpException('Error calling external API', HttpStatus.INTERNAL_SERVER_ERROR);
      }
    }
