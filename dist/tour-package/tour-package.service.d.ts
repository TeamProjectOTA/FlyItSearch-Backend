...
export declare class TourPackageService {
    ...
    constructor(tourPackageRepository: Repository<TourPackage>, introductionRepository: Repository<Introduction>, overviewRepository: Repository<Overview>, mainImageRepository: Repository<MainImage>, visitPlaceRepository: Repository<VisitPlace>, adminRepository: Repository<Admin>);
